...
class SubjectService {
    ...
    public List<SubjectDto> get() {
        return subjectRepository.findByUserEmail(SecurityContextHolder.getContext().getAuthentication().getName())
                .stream()
    ...
    public SubjectDto subjectCreate(SubjectDto.SubjectCreate entity) {
        ...
        var user = usersRepository.findByEmail(email).orElseThrow(() -> new IllegalArgumentException("User not found"));
